...
window.onload = function init() {
    ...
    gl.uniform1i( gl.getUniformLocation(program, "vertexBool"), vertexBool);

    gl.uniform4fv( gl.getUniformLocation(program, "ambientProductBlinnPhong"), flatten(ambientProduct) );
    gl.uniform4fv( gl.getUniformLocation(program, "diffuseProductBlinnPhong"), flatten(diffuseProduct) );
    gl.uniform4fv( gl.getUniformLocation(program, "specularProductBlinnPhong"), flatten(specularProduct) );
    gl.uniform1f( gl.getUniformLocation(program, "shininessBlinnPhong"), materialShininess );
    gl.uniform1i( gl.getUniformLocation(program, "fragmentBool"), fragmentBool);
