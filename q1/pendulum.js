...
var render = function() {
    ...
    theta[LowerArm] += incRotTail;
    if( theta[LowerArm] > 35.0  || theta[LowerArm] < -35.0 )
        incRotTail *= -1;

    theta[UpperArm] += incRotTail2;
    if( theta[UpperArm] > 35.0  || theta[UpperArm] < -35.0 )
        incRotTail2 *= -1;
    ...
    modelViewMatrix = mult(modelViewMatrix, rotateZ( 180.0 ));
