...
window.onload = function init() {
    ...
    gl.uniform1f( gl.getUniformLocation(program, "maxDimple"), maxDimple );
...
function render() {
    ...
    modelViewMatrix = mult( modelViewMatrix, scalem( size, size, size) ); //Breyta þessu til að uppfylla b lið
