...
window.onload = function init() {
    ...
    // Lesa inn og skilgreina mynstur fyrir gólf
    var cloudsImage = document.getElementById("CloudsImage");
...
var render = function(){
    ...
    // Teikna vegg með mynstri
    gl.bindTexture( gl.TEXTURE_2D, texVegg );
    gl.drawArrays( gl.TRIANGLES, numVertices+numVertices+numVertices, numVertices );

    // Teikna gólf með mynstri
    gl.bindTexture( gl.TEXTURE_2D, texGolf );
    gl.drawArrays( gl.TRIANGLES, numVertices+numVertices+numVertices+numVertices, numVertices );
    

    // Teikna gólf með mynstri
    gl.bindTexture( gl.TEXTURE_2D, texClouds );
    gl.drawArrays( gl.TRIANGLES, numVertices+numVertices+numVertices+numVertices+numVertices, numVertices );
